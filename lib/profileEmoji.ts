...
export const FAITH_EMOJI: Record<string, string> = {
    ...
    dhikr_regular: '\u{1F4FF}',
    regular_in_dhikr: '\u{1F4FF}',
    fasts_ramadan: '\u{1F319}',
    fasts_in_ramadan: '\u{1F319}',
    fasts_sunnah: '\u{1F4C5}',
    ...
    avoids_interest_riba: '\u{1F4C9}',
    avoids_interest: '\u{1F4C9}',
    avoids_alcohol: '\u{1F377}',
    avoids_smoking: '\u{1F6AD}',
    avoids_clubbing: '\u{1FAA9}',
    ...
    forgiving: '\u{1FAF6}',
    respectful: '\u{1F647}',
    respectful_to_others: '\u{1F647}',
    low_drama_peaceful: '\u{1F54A}\u{FE0F}',
    growth_in_deen: '\u{1F33E}',
    focused_on_growing_in_deen: '\u{1F33E}',
    family_oriented: '\u{1F49E}',
    respects_parents: '\u{2764}\u{FE0F}',
    close_to_family: '\u{1F3E1}',
    values_marriage: '\u{1F48D}',
    wants_children: '\u{1F9F8}',
    does_not_want_children: '\u{1F6AB}',
    open_to_have_children: '\u{1F37C}',
    open_to_children: '\u{1F476}',
    supports_spouse_goals: '\u{1F680}',
    shared_decision_making: '\u{1F5F3}\u{FE0F}',
    community_minded: '\u{1F30D}',
    volunteers_charity_work: '\u{1F381}',
    keeps_good_company: '\u{1FAC2}',
    balances_deen_dunya: '\u{2696}\u{FE0F}',
    balances_deen_and_duniya: '\u{2696}\u{FE0F}',
    attends_mosque: '\u{1F6B6}',
    studies_hadith: '\u{1F4DC}',
    modest_dressing: '\u{1F9D5}',
    islamic_lectures: '\u{1F399}\u{FE0F}',
    learns_islam: '\u{1F9E0}',
};
